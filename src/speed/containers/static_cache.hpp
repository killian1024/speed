...
#include "containers_exception.hpp"
#include "flags.hpp"
#include "i_const_mutable_iterator.hpp"
...
/** Contains all biffer cache buffers flags. */
...
public:
     ...
     */
    class const_iterator : public i_const_iterator<value_type, const_iterator>
    {
    public:
        /** The class itself. */
        ...
        /** The base class. */
        using base_type = i_const_iterator<value_type, const_iterator>;
     ...
     */
    class iterator : public i_const_mutable_iterator<value_type, const_iterator, iterator>
    {
    public:
        /** The class itself. */
        ...
        /** The base class. */
        using base_type = i_const_mutable_iterator<value_type, const_iterator, iterator>;
    ...
    // TODO(killian.poulaud@etu.upmc.fr): Implement the reverce iterators.
    ...
    // TODO(killian.poulaud@etu.upmc.fr): Implement copy and move operators.
    /** @cond */
     ...
     * @throw       speed::containers::insertion_exception : If the key is found in the container
...
protected:
    ...
    void erase_from_hash_buffer(buffer* buf) noexcept
    {
        ...
        buf->flgs_.erase(scbf_t::INSERTED_IN_HASH_BUFFER);
    }
    ...
    void erase_from_available_list(buffer* buf) noexcept
    {
        ...
        buf->flgs_.erase(scbf_t::INSERTED_IN_AVAILABLE_LIST);
    }
