...
public:
    ...
    public:
         ...
         * @throw       speed::containers::bad_iteration_exception : This exception is always throw.
         */
        const value_type* operator ->() const override
        {
     ...
     * @param       flg : Flag to erase in the conteiner.
     */
    inline flags& erase(const value_type& flg) noexcept
    {
        val_ = static_cast<value_type>(static_cast<underlying_type>(val_) &
                                       ~static_cast<underlying_type>(flg));
    ...
    /**
     * @brief       Erase a flag in the conteiner.
     * @param       indx : Index in which erase a flag in the conteiner.
     */
    inline flags& erase_by_index(std::uint8_t indx) noexcept
    {
        val_ = static_cast<value_type>(static_cast<underlying_type>(val_) & ~(1u << indx));
