...
/**
 * @file       speed/containers/i_const_iterator.hpp
 * @brief      i_const_iterator interface header.
 * @author     Killian
 * @date       2018/01/19 - 22:17
 */

#ifndef SPEED_CONTAINERS_I_CONST_ITERATOR_HPP
#define SPEED_CONTAINERS_I_CONST_ITERATOR_HPP
...
class i_const_iterator : public virtual i_iterator<TpValue, TpIterator>
{
public:
    ...
    /** The class itself. */
    using self_type = i_const_iterator<value_type, iterator_type>;
