...
{
    speed::system::set_terminal_text_attribute(
            os, speed::system::terminal_text_attribute::DEFAULT);
    return os;
}
...
{
    speed::system::set_terminal_text_attribute(
            os, speed::system::terminal_text_attribute::BLACK);
    return os;
}
...
{
    speed::system::set_terminal_text_attribute(
            os, speed::system::terminal_text_attribute::RED);
    return os;
}
...
{
    speed::system::set_terminal_text_attribute(
            os, speed::system::terminal_text_attribute::GREEN);
    return os;
}
...
{
    speed::system::set_terminal_text_attribute(
            os, speed::system::terminal_text_attribute::BROWN);
    return os;
}
...
{
    speed::system::set_terminal_text_attribute(
            os, speed::system::terminal_text_attribute::BLUE);
    return os;
}
...
{
    speed::system::set_terminal_text_attribute(
            os, speed::system::terminal_text_attribute::PURPLE);
    return os;
}
...
{
    speed::system::set_terminal_text_attribute(
            os, speed::system::terminal_text_attribute::CYAN);
    return os;
}
...
{
    speed::system::set_terminal_text_attribute(
            os, speed::system::terminal_text_attribute::LIGHT_GRAY);
    return os;
}
...
{
    speed::system::set_terminal_text_attribute(
            os, speed::system::terminal_text_attribute::DARK_GRAY);
    return os;
}
...
{
    speed::system::set_terminal_text_attribute(
            os, speed::system::terminal_text_attribute::LIGHT_RED);
    return os;
}
...
{
    speed::system::set_terminal_text_attribute(
            os, speed::system::terminal_text_attribute::LIGHT_GREEN);
    return os;
}
...
{
    speed::system::set_terminal_text_attribute(
            os, speed::system::terminal_text_attribute::YELLOW);
    return os;
}
...
{
    speed::system::set_terminal_text_attribute(
            os, speed::system::terminal_text_attribute::LIGHT_BLUE);
    return os;
}
...
{
    speed::system::set_terminal_text_attribute(
            os, speed::system::terminal_text_attribute::LIGHT_PURPLE);
    return os;
}
...
{
    speed::system::set_terminal_text_attribute(
            os, speed::system::terminal_text_attribute::LIGHT_CYAN);
    return os;
}
...
{
    speed::system::set_terminal_text_attribute(
            os, speed::system::terminal_text_attribute::WHITE);
    return os;
}
