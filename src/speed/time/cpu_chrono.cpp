 ...
 * @brief      cpu_chrono class definition.
 * @author     Killian
...
bool cpu_chrono::start() noexcept
{
    if (chrn_state_ == chrono_states::READY)
    {
        ...
        speed::system::get_cpu_time(&start_time_spec_);
        return true;
    }
...
bool cpu_chrono::stop() noexcept
{
    if (chrn_state_ == chrono_states::RUNNING)
    {
        ...
        speed::system::get_cpu_time(&elapsed_time_spec_);
...
long double cpu_chrono::get_elapsed_time() const noexcept
{
    ...
    {
        speed::system::get_cpu_time(&cur_time_spec);
...
speed::system::time_specification cpu_chrono::get_elapsed_raw_time() const noexcept
{
    ...
    {
        speed::system::get_cpu_time(&elapsed_tme);
