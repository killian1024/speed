...
/**
 * @file       speed/time/i_chrono.hpp
 * @brief      i_chrono class header.
 * @author     Killian
...
public:
     ...
     */
    virtual speed::system::time_specification get_elapsed_raw_time() const noexcept = 0;
    ...
    ) const
    {
        ...
        std::uint8_t i = 0;
        speed::system::time_specification elapsd_time = get_elapsed_raw_time();
        ...
        {
            decimls[i] = (char)(elapsd_time.nsec / cur_divider) + '0';
            elapsd_time.nsec %= cur_divider;
            cur_divider /= 10;
        }
