...
/**
 * @file       speed/time/child_cpu_chrono.hpp
 * @brief      child_cpu_chrono class header.
 * @author     Killian
 * @date       2018/06/28 - 05:02
 */

#ifndef SPEED_TIME_CHILD_CPU_CHRONO_HPP
#define SPEED_TIME_CHILD_CPU_CHRONO_HPP
...
/**
 * @brief       Class that represents a child cpu chrono.
 */
class child_cpu_chrono : public i_chrono
{
public:
    /**
     * @brief       Default constructor.
     */
    child_cpu_chrono() noexcept;
