 ...
 * @brief      monotonic_chrono class definition.
 * @author     Killian
...
bool monotonic_chrono::start() noexcept
{
    if (chrn_state_ == chrono_states::READY)
    {
        ...
        speed::system::get_monotonic_time(&start_time_spec_);
        return true;
    }
...
bool monotonic_chrono::stop() noexcept
{
    if (chrn_state_ == chrono_states::RUNNING)
    {
        ...
        speed::system::get_monotonic_time(&elapsed_time_spec_);
...
long double monotonic_chrono::get_elapsed_time() const noexcept
{
    ...
    {
        speed::system::get_monotonic_time(&cur_time_spec);
...
speed::system::time_specification monotonic_chrono::get_elapsed_raw_time() const noexcept
{
    ...
    {
        speed::system::get_monotonic_time(&elapsed_tme);
