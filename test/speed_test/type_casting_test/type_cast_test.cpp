...
/**
 * @file        speed_test/type_casting_test/type_cast_test.cpp
 * @brief       type_cast unit test.
 * @author      Killian
 * @date        2018/06/06 - 16:24
 */

#include <filesystem>

#include "gtest/gtest.h"
#include "speed/type_casting.hpp"
...
TEST(type_casting_type_cast, c_string_to_integral_signed)
{
    ...
    EXPECT_THROW(speed::type_casting::type_cast<int>(""), speed::type_casting::type_casting_exception);
    EXPECT_THROW(speed::type_casting::type_cast<int>("\0"), speed::type_casting::type_casting_exception);
    EXPECT_THROW(speed::type_casting::type_cast<int>("1238*7645"), speed::type_casting::type_casting_exception);
}
...
TEST(type_casting_type_cast, c_string_to_integral_unsigned)
{
    ...
    ASSERT_TRUE(speed::type_casting::type_cast<unsigned int>("+342432") == +342432);
    EXPECT_THROW(speed::type_casting::type_cast<unsigned int>("-342432"), speed::type_casting::type_casting_exception);
    EXPECT_THROW(speed::type_casting::type_cast<unsigned int>(""), speed::type_casting::type_casting_exception);
    EXPECT_THROW(speed::type_casting::type_cast<unsigned int>("\0"), speed::type_casting::type_casting_exception);
    EXPECT_THROW(speed::type_casting::type_cast<unsigned int>("1238*7645"), speed::type_casting::type_casting_exception);
}
